    ...
    <div class="detector-container">
      <div class="detector-header">
        ...
        <p class="section-subtitle">
          Paste your text below and get instant AI detection results
        </p>
      </div>
        ...
        <div class="detector-grid">
          ...
          <div class="input-section">
            <div class="input-header">
              ...
              <div
                class="char-counter"
                :class="{ 'text-red-500': text.length > 10000 }"
              >
                {{ text.length }} / 10,000
              </div>
            </div>
            ...
            <div class="input-footer">
              ...
              <button
                ...
                :class="{
                  'opacity-50 cursor-not-allowed': !text.trim() || isLoading,
                }"
              >
                <span v-if="!isLoading">
          ...
          <div class="results-section">
            <div v-if="!hasAnalyzed && !isLoading" class="results-placeholder">
              ...
              <p class="placeholder-text">
                Enter your text and click "Analyze Text" to get detailed AI
                detection insights
              </p>
            </div>
            ...
            <div
              v-if="hasAnalyzed && !isLoading && results"
            ...
            >
              ...
              <div class="score-display">
                <div class="score-header">
                  ...
                  <div
                    class="score-badge"
                    :class="getScoreBadgeClass(results.aiScore)"
                  >
                ...
                <div class="score-circle-container">
                  <svg class="score-circle" viewBox="0 0 200 200">
                    ...
                    <circle
                      ...
                      r="85"
                      :style="{
                        strokeDashoffset: getCircleOffset(results.aiScore),
                      }"
                    ></circle>
                  </svg>
                  <div class="score-value">
                    <span class="score-number"
                      >{{ Math.round(results.aiScore) }}%</span
                    >
                ...
                <div class="metric-card">
                  ...
                  <div class="metric-content">
                    ...
                    <div class="metric-value">
                      {{ Math.round(100 - results.aiScore) }}%
                    </div>
                  </div>
                </div>
              ...
              <div
                v-if="
                  ...
                  results.detailedInsights.length > 0
                "
              ...
              <div class="export-section" style="margin-top: 1.5rem">
                <ExportControls :results="results" :text="text" />
              </div>
            </div>
  ...
  methods: {
    async analyzeText() {
      ...
      if (!this.apiKey || !this.apiHost) {
        this.error =
          "API credentials are missing. Please set VITE_RAPIDAPI_KEY and VITE_RAPIDAPI_HOST in your .env file.";
        return;
      }
    ...
    generateInsights(aiScore, data) {
      ...
      if (aiScore > 70) {
        insights.push(
          {
            ...
            score: aiScore + Math.random() * 10 - 5,
          },
          {
            label: "Sentence Structure",
            score: aiScore + Math.random() * 15 - 7,
          },
          {
        ...
        insights.push(
          ...
          {
            label: "Sentence Structure",
            score: aiScore + Math.random() * 20 - 10,
          },
          {
            label: "Vocabulary Usage",
            score: aiScore + Math.random() * 15 - 7,
        ...
        insights.push(
          ...
          {
            label: "Sentence Structure",
            score: aiScore + Math.random() * 25 - 12,
          },
          {
            label: "Vocabulary Usage",
            score: aiScore + Math.random() * 20 - 10,
